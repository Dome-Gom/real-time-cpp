...
//
  ...
  #define APP_BENCHMARK_TYPE_BOOST_MATH_METAL     14
  ...
  #define APP_BENCHMARK_TYPE   APP_BENCHMARK_TYPE_BOOST_MATH_METAL
  ...
  bool run_pi_agm();
  #elif(APP_BENCHMARK_TYPE == APP_BENCHMARK_TYPE_BOOST_MATH_METAL)
  bool run_boost_math_metal();
  #endif
